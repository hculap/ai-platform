...
const resources = {
  ...
  en: {
    translation: {
      ...
      "agents.subtitle": "Wybierz agenta, aby przeanalizować swoją stronę internetową i automatycznie utworzyć profil biznesowy",
      "agents.available": "Dostępnych agentów",
