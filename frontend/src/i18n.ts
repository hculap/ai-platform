...
const resources = {
  ...
  en: {
    translation: {
      ...
      // Business Profiles
      "businessProfiles.title": "Profile Biznesowe",
      "businessProfiles.subtitle": "Zarządzaj swoimi profilami biznesowymi",
      "businessProfiles.createNew": "Utwórz Nowy Profil",
      "businessProfiles.search.placeholder": "Szukaj profili...",
      "businessProfiles.loading": "Ładowanie profili...",
      "businessProfiles.noProfiles": "Brak profili biznesowych",
      "businessProfiles.createFirst": "Utwórz swój pierwszy profil biznesowy, aby rozpocząć",
      "businessProfiles.createFirstProfile": "Utwórz Swój Pierwszy Profil",
      "businessProfiles.noSearchResults": "Nie znaleziono profili",
      "businessProfiles.tryDifferentSearch": "Spróbuj dostosować swoje wyszukiwanie",
      "businessProfiles.created": "Utworzono",
      "businessProfiles.form.createTitle": "Utwórz Nowy Profil Biznesowy",
      "businessProfiles.form.editTitle": "Edytuj Profil Biznesowy",
      "businessProfiles.form.createSubtitle": "Dodaj nowy profil biznesowy do swojego konta",
      "businessProfiles.form.editSubtitle": "Zaktualizuj informacje o swoim profilu biznesowym",
      "businessProfiles.form.name": "Nazwa Firmy",
      "businessProfiles.form.website": "Adres Strony Internetowej",
      "businessProfiles.form.description": "Opis Oferty",
      "businessProfiles.form.targetCustomer": "Docelowi Klienci",
      "businessProfiles.form.problemSolved": "Rozwiązywane Problemy",
      "businessProfiles.form.customerDesires": "Potrzeby Klientów",
      "businessProfiles.form.brandTone": "Ton Marki",
      "businessProfiles.form.communicationLanguage": "Język Komunikacji",
      "businessProfiles.form.isActive": "Profil aktywny",
      "businessProfiles.form.isActiveDescription": "Nieaktywne profile nie będą widoczne dla klientów",
      "businessProfiles.form.nameRequired": "Nazwa firmy jest wymagana",
      "businessProfiles.form.websiteRequired": "Adres strony jest wymagany",
      "businessProfiles.form.websiteInvalid": "Nieprawidłowy format adresu URL",
      "businessProfiles.form.descriptionRequired": "Opis oferty jest wymagany",
      "businessProfiles.form.websiteLocked": "Adres strony nie może być zmieniony podczas edycji",
      "businessProfiles.form.namePlaceholder": "np. Moja Firma Sp. z o.o.",
      "businessProfiles.form.descriptionPlaceholder": "Opisz swoją ofertę, produkty lub usługi...",
      "businessProfiles.form.targetCustomerPlaceholder": "Kim są Twoi idealni klienci?",
      "businessProfiles.form.problemSolvedPlaceholder": "Jakie problemy rozwiązujesz dla klientów?",
      "businessProfiles.form.customerDesiresPlaceholder": "Czego pragną Twoi klienci?",
      "businessProfiles.form.brandTonePlaceholder": "np. Profesjonalny, Przyjazny, Innowacyjny",
      "businessProfiles.form.saving": "Zapisywanie...",
      "businessProfiles.form.create": "Utwórz",
      "businessProfiles.form.update": "Zaktualizuj",
      "businessProfiles.activeProfileNote": "Uwaga: Tylko jeden profil może być aktywny jednocześnie. Aktywny profil jest wybierany w nagłówku.",
      "businessProfiles.deleted": "Usunięto",
      "businessProfiles.deleteFailed": "Usuwanie nie powiodło się",
      "businessProfiles.lastProfileError": "Nie można usunąć ostatniego profilu biznesowego. Każdy użytkownik musi mieć przynajmniej jeden profil.",
      "businessProfiles.deleteConfirm": "Czy na pewno chcesz usunąć ten profil biznesowy?",
      "businessProfiles.deleteConfirmTitle": "Potwierdź usunięcie",
      "businessProfiles.cancel": "Anuluj",
      "businessProfiles.edit": "Edytuj",
      "businessProfiles.delete": "Usuń",
      "businessProfiles.viewWebsite": "Zobacz stronę",
      "businessProfiles.noDescription": "Brak opisu",
      "businessProfiles.searching": "Szukam...",
      "businessProfiles.searchResults": "Znaleziono {{count}} {{type}}",
      "businessProfiles.profile": "Profil",
      "businessProfiles.profiles": "Profili",
      "businessProfiles.of": "z",
      "businessProfiles.totalActive": "Łącznie aktywnych",
      "businessProfiles.active": "Aktywny",
      "businessProfiles.inactive": "Nieaktywny",
      "businessProfiles.description": "Opis",
      "businessProfiles.editProfile": "Edytuj Profil",
      "businessProfiles.website": "Strona internetowa",
